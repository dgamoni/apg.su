...
$arrayjs = '
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgH7SjznVJHMY3Z_bVwoPp9m2PpAUk3hA&v=3.exp&language=en"></script>
			...
			<div class="row">
				<div class="col-md-12">
					<?php if (function_exists('dimox_breadcrumbs')): ?>
						<div class="breadcrumbs"><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/eng/" itemprop="url"><span itemprop="title">Home</span></a></span> <span class="sep">›</span> <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/eng/plants/" itemprop="url"><span itemprop="title">Plants Europlast</span></a></span> <span class="sep">›</span> <span class="current"><?php echo $title; ?></span></div>
					<?php endif; ?>
					<div class="title">
			...
			<div class="row">
				<?php
					foreach ($fields['wpcf-photo'] as $value) {
						echo '<img src="'.$value.'" alt="APG Europlast PET production '.$title.'" />';
					}
				?>
			</div>
			<div class="row margin">
				<div class="col-md-12"><h3>History of the plant</h3></div>
