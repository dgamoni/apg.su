			...
			<div class="row">
				<div class="col-md-12">
					<?php if (function_exists('dimox_breadcrumbs')): ?>
						<div class="breadcrumbs"><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/eng/" itemprop="url"><span itemprop="title">Home</span></a></span> <span class="sep">›</span> <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/eng/catalog/" itemprop="url"><span itemprop="title">Catalog production</span></a></span> <span class="sep">›</span> <span class="current"><?php echo $title; ?></span></div>
					<?php endif; ?>
					<div class="title">
						<h2>Catalog production</h2>
		...
		<div class="container" style="margin-bottom: 20px">
			...
			<div class="row">
				<div class="col-md-8" style="margin: 30px auto 0; float: none;">
					<p style="font-size: 0.9rem; text-align: center">If you find it difficult to choose the best option package, <a href="/eng/contacts/feedback/">send your request</a> our sales department.</p>
				</div>
			</div>
		</div>
