	...
	<div class="wrapper container--catalog--all">
		<div class="bg_pet">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<a href="/product-category/pet-preforma/voda/">
							<div class="block--img">
					...
					<div class="col-md-4">
						<a href="/product-category/pet-preforma/moloko/">
							<div class="block--img">
					...
					<div class="col-md-4">
						<a href="/product-category/pet-preforma/pivo/">
							<div class="block--img">
				...
				<div class="row">
					<div class="col-md-4">
						<a href="/product-category/pet-preforma/maslo/">
							<div class="block--img">
					...
					<div class="col-md-4">
						<a href="/product-category/pet-preforma/dlya-sousov/">
							<div class="block--img">
					...
					<div class="col-md-4">
						<a href="/product-category/pet-preforma/himiya/">
							<div class="block--img">
			...
			<div class="container">
				...
				<div class="row bottle--block">
					<div class="bottle--block--obj">
						...
						<a href="/shop?filter_volume=0-1"><div class="title">0,1 л</div></a>
					</div>
					<div class="bottle--block--obj">
						<div><img src="/wp-content/themes/apg/img/catalog/bottle/0_3.gif" alt="0,3 л"></div>
						<a href="/shop?filter_volume=0-3"><div class="title">0,3 л</div></a>
					</div>
					<div class="bottle--block--obj">
						<div><img src="/wp-content/themes/apg/img/catalog/bottle/1.gif" alt="1 л"></div>
						<a href="/shop?filter_volume=1-0"><div class="title">1 л</div></a>
					</div>
					<div class="bottle--block--obj">
						<div><img src="/wp-content/themes/apg/img/catalog/bottle/0_5.jpg" alt="0,5 л"></div>
						<a href="/shop?filter_volume=0-5"><div class="title">0,5 л</div></a>
					</div>
					<div class="bottle--block--obj">
		...
		<div class="bg_pet">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<a href="/product-category/pet-butyil-19-litrov/">
							<div class="block--img">
					...
					<div class="col-md-4">
						<a href="/product-category/pet-kega-30-litrov/">
							<div class="block--img">
					...
					<div class="col-md-4">
						<a href="/product-category/lazerpet/">
							<div class="block--img">
